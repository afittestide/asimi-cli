...
// setCursorBarCmd returns a tea.Cmd that changes the cursor to a blinking bar.
func setCursorBarCmd() tea.Cmd {
	return func() tea.Msg {
		fmt.Print("\x1b[5 q")
		return nil
	}
...
// setCursorBlockCmd returns a tea.Cmd that changes the cursor to a block.
func setCursorBlockCmd() tea.Cmd {
	return func() tea.Msg {
...
func (m TUIModel) handleCustomMessages(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case initializeProjectMsg:
		...
		m.content.Chat.AddMessage("🚀 Starting project initialization...")
